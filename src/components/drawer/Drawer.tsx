...
export default function Drawer({ isOpen, links, closeDrawer }: DrawerProps){
    return (
        <>
        <div className={`${!isOpen && "opacity-0 pointer-events-none" } lg:opacity-0 lg:pointer-events-none absolute inset-0 bg-black opacity-30 z-10 transition-opacity ease-in-out duration-300  `}></div>
