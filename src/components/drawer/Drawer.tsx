...
export default function Drawer({ isOpen, links, closeDrawer }: DrawerProps){
    return (
        <>
        <div className={`${isOpen ? "opacity-30" : "opacity-0 pointer-events-none" } lg:hidden absolute inset-0 bg-black  z-10 transition-opacity ease-in-out duration-300  `}></div>
